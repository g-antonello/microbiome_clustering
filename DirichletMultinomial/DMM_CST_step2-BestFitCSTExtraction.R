...
# save table as csv
write.csv(df, file=file.path(opts_args$output, "DMM_output_data", "03_taxon_contribution_k6_model.csv"))


### plot heatmap of read counts for samples and community types

{pdf(file.path(opts_args$output, "DMM_output_figures", "04_heatmap_reads_Samples.pdf"))
